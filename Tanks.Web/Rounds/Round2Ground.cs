...
{
    public class Round2Ground : Ground
    {
      Round2GroundBrush brush;

       public Round2Ground(PhysicsSimulator simulator)
           : base(simulator)
        {
        ...
        void Initialize()
        {
            ...
            vertices.Add(new Vector2(300, 629));
            ...
            this.brush = new Round2GroundBrush();
